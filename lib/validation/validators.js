_.mixin({
  ...
  presenceOf: function(field) {
    ...
    return function(doc) {
      ...
      if (_.isUndefined(value) || _.str.isBlank(value)) {
        var message = _.str.humanize(field.replace('.', ' ')) + ' cannot be blank';
        return {
          field: field,
          message: message
        };
  ...
  formatOf: function(field, regex, messageSuffix) {
    return function(doc) {
      ...
      if (value && !regex.test(value)) {
        var message = _.str.humanize(field.replace('.', ' ')) + ' ' + messageSuffix;
        return {
          field: field,
          message: message
        };
  ...
  lengthOf: function(field, options) {
    return function(doc) {
      ...
      if (value && options.lte && options.gte && (value.length > options.lte || value.length < options.gte))
        message = _.str.humanize(field.replace('.', ' ')) + ' must be between ' + options.gte + ' and ' + options.lte + ' characters';
  ...
  uniquenessOf: function(field, options) {
    return function(doc) {
      ...
      if (value && options.in) {
        ...
        if (count > 0) {
          var message = _.str.humanize(field.replace('.', ' ')) + ' must be unique';
          return {
            field: field,
            message: message
          };
  ...
  validUrl: function(field) {
    return function(doc) {
      ...
      if (value && !urlMatcher.test(value)) {
        var message = _.str.humanize(field.replace('.', ' ')) + ' must be a valid URL';
        return {
          field: field,
          message: message
        };
  ...
  validEmail: function(field) {
    return function(doc) {
      ...
      if (value && !emailMatcher.test(value)) {
        var message = _.str.humanize(field.replace('.', ' ')) + ' must be a valid email address';
        return {
          field: field,
          message: message
        };
